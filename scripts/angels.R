...
output_markdown(date_game(tomorrow_game_id, season), "output/Angels/angels_tomorrow_game.md")

# Create output file for the games' box scores
output_markdown(make_box_score(teamID, today), "output/Angels/angels_today_box_score.md")
output_markdown(make_box_score(teamID, yesterday), "output/Angels/angels_yesterday_box_score.md")
