### Variables for the New York Mets

teamID <- 121 # New York Mets
...
write_half_inning_tables(grouped(pbp_half(yesterday_game_id)), "output/Mets/mets_yesterday_play_by_play.md")